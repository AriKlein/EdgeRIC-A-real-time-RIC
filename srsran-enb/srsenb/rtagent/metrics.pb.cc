...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_metrics_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::UeMetrics, backlog_),
  PROTOBUF_FIELD_OFFSET(::UeMetrics, snr_),
  PROTOBUF_FIELD_OFFSET(::UeMetrics, pending_data_),
  ...
  PROTOBUF_FIELD_OFFSET(::Metrics, ric_cnt_),
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_metrics_2eproto = {
  false, false, descriptor_table_protodef_metrics_2eproto, "metrics.proto", 228,
    ...
    switch (tag >> 3) {
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 40)) {
          pending_data_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      // float tx_bytes = 6;
...
::PROTOBUF_NAMESPACE_ID::uint8* UeMetrics::_InternalSerialize(
  ...
  if (this->backlog() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt32ToArray(3, this->_internal_backlog(), target);
  }

  // float snr = 4;
  if (!(this->snr() <= 0 && this->snr() >= 0)) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteFloatToArray(4, this->_internal_snr(), target);
  }

  // uint32 pending_data = 5;
  if (this->pending_data() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt32ToArray(5, this->_internal_pending_data(), target);
  }

  // float tx_bytes = 6;
  if (!(this->tx_bytes() <= 0 && this->tx_bytes() >= 0)) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteFloatToArray(6, this->_internal_tx_bytes(), target);
  }

  // float rx_bytes = 7;
  if (!(this->rx_bytes() <= 0 && this->rx_bytes() >= 0)) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteFloatToArray(7, this->_internal_rx_bytes(), target);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:UeMetrics)
  ...
  if (from.pending_data() != 0) {
    _internal_set_pending_data(from._internal_pending_data());
  }
...
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  ...
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 24)) {
          ric_cnt_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
...
::PROTOBUF_NAMESPACE_ID::uint8* Metrics::_InternalSerialize(
  ...
  if (this->ric_cnt() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt32ToArray(3, this->_internal_ric_cnt(), target);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:Metrics)
  ...
  if (from.ric_cnt() != 0) {
    _internal_set_ric_cnt(from._internal_ric_cnt());
  }
}
...
void Metrics::InternalSwap(Metrics* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(Metrics, ric_cnt_)
      + sizeof(Metrics::ric_cnt_)
      - PROTOBUF_FIELD_OFFSET(Metrics, tti_cnt_)>(
          reinterpret_cast<char*>(&tti_cnt_),
          reinterpret_cast<char*>(&other->tti_cnt_));
}
